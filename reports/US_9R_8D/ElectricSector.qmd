...
function makeFixedCostPlot(region_view, tech_view) {
  ...
  return Plot.plot({
      ...
      color: {legend: true},
      marks: [
          Plot.barY(filtered_data, {x: "vintage", y: "cost_fixed", fill: "tech", strokeWidth: 2})
      ],
  })
}
...
function makeVariableCostPlot(region_view, tech_view) {
  ...
  return Plot.plot({
      ...
      color: {legend: true},
      marks: [
          Plot.barY(filtered_data, {x: "vintage", y: "cost_variable", fill: "tech", strokeWidth: 2})
      ],
  })
}
...
viewof capacity_region_view = Inputs.select(capacity_region_set, {label: "region", multiple: true})
viewof capacity_tech_view = Inputs.select(capacity_tech_set, {label: "technology", multiple: true})
  ...
  return Plot.plot({
      ...
      marks: [
          Plot.lineY(filtered_data,
                    {y: "cf_tech", stroke: "tech", strokeWidth: 2})
      ],
  })
}
